...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckOutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer { Id = "1", Email = "email@gmail.com", ZipCode = "90210" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("email@gmail.com", "Forms"), null);
